      ...
      <form onSubmit={handleSubmit} id="signup-form">
        ...
        <div style={{ marginBottom: 16 }}>
          <Input
            ...
            id="signup-email"
            type="email"
            placeholder="dionahza@crygleacademy.com"
            value={email}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '24px 0' }}>
          ...
          <span style={{ fontSize: 13, color: 'var(--grey-400)', whiteSpace: 'nowrap' }}>Atau daftar dengan</span>
          <span style={{ flex: 1, height: 1, background: 'var(--grey-100)' }} />
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: 'var(--grey-500)' }}>
          Apakah kamu sudah memiliki akun? Silahkan{' '}

...
const routes = [
  ...
  { heading: 'Halo, Selamat Datang 👋', importPage: () => import('./login/page') },
  { heading: 'Silahkan Membuat Akun', importPage: () => import('./signup/page') },
  { heading: 'Lupa Password', importPage: () => import('./lupa-password/page') },
  { heading: 'Verifikasi Email Kamu', importPage: () => import('./verifikasi/page') },
  { heading: 'Metode Pembayaran', importPage: () => import('./checkout/page') },
  { heading: 'Konfirmasi Pembayaran', importPage: () => import('./checkout/review/page') },
  { heading: 'Memproses pembayaran kamu...', importPage: () => import('./checkout/processing/page') },
  { heading: 'Pembayaran Berhasil! 🎉', importPage: () => import('./checkout/berhasil/page') },
  { heading: 'Pembayaran Belum Berhasil', importPage: () => import('./checkout/gagal/page') },

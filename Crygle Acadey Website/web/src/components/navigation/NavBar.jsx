  ...
  return (
    <header style={{ display: 'flex', flexDirection: 'row', width: '100%', padding: '22px var(--gutter)', justifyContent: 'space-between', alignItems: 'center', boxSizing: 'border-box', ...style }} {...rest}>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', gap: 6, alignItems: 'center' }}>
        <button type="button" onClick={onLogin} style={{ height: 59, padding: '20px 34px', border: 0, borderRadius: 'var(--radius-pill)', background: 'transparent', boxShadow: 'var(--shadow-cta)', cursor: 'pointer', fontFamily: 'var(--font-core)', fontWeight: 500, fontSize: 16, lineHeight: '100%', color: 'var(--blue-500)', whiteSpace: 'nowrap' }}>Masuk</button>
        <button type="button" onClick={onSignup} style={{ height: 59, padding: '20px 34px', border: 0, borderRadius: 'var(--radius-pill)', background: 'var(--blue-500)', boxShadow: 'var(--shadow-cta-brand)', cursor: 'pointer', fontFamily: 'var(--font-core)', fontWeight: 500, fontSize: 16, lineHeight: '100%', color: 'var(--background-1)', whiteSpace: 'nowrap' }}>Daftar</button>
      </div>
    </header>
  );
}
